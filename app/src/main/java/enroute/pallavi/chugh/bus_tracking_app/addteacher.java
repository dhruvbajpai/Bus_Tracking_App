...
public class addteacher extends ActionBarActivity implements View.OnClickListener{
    ...
    static Bitmap bm;
    static dialogteacher dialog;
    static Uri mCapturedImageURI;
    ImageButton imagechange;
    Button save;
    String root;
    EditText name,phn,pass,user,route;
    ...
    public void onClick(View v) {
        ...
        /*if(filename=="") {
            ...
            ParseObject imgupload = new ParseObject("route_teacher");
            if(filename!="") {
